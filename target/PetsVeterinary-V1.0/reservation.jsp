...
<div class="row col-sm-10 col-md-8 col-lg-6 mx-auto bg-primar card mb-5">
    <form action="ReservationController" method="post" class="row  mb-3 mt-3">
        ...
        <div class=" col-12 col-md-6 col-xxl-4">
            ...
            <input type="date" class="form-control form-control" name="reservation_date">
        </div>

        <div class=" col-12 col-md-6 col-xxl-4">
            <label class="col-form-label">Hora</label>
            <select class="form-select form-select" name="hour_id">
        ...
        <div class="col-md-12 d-flex justify-content-end">
            <button type="submit" class="btn btn-success mt-3" <c:if test="${user == null}"> disabled</c:if> >Reservar</button>
